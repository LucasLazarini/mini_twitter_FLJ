  ...
  <body id="fundo">
    <?php session_start(); ?>
      ...
      <header id="menuLateral">
        ...
        <!-- <div class="botoesMenu" id="opConta">
          <select id="textConta" required>
            <option>Conta</option>
            <option  value="">Alterar Foto</option>
            <option  value="">Alterar Nome</option>
            <option  value="">Alterar Senha</option>
            <option  value="">Alterar Email</option>
            <option  value="">Alterar Cidade</option>
            <option  value="">Alterar Website</option>
        </select> -->
      </div>
