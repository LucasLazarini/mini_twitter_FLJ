    ...
    <?php session_start(); ?>
      ...
      <section id="timeLine">
        ...
        require_once('../back/conexao.php');
          ...
          $query = "select tweets.id, date, message, username, picture from tweets inner join users on tweets.user_id = users.id order by date desc";
          ...
          while ($dados = $result->fetch_array()) {
            ...
            echo    "<img src=".$dados['picture']." id="."fotoTweet".">"."<span id="."usernamePost".">".$dados['username']."</span>"."<button type=".'button'." name=".'button'. "class="."botaoLike"." onclick=".'add_like('.$id_twittiASerCurtido.')'.">"."<img src="."../imagens/like.png"." alt="."LIKE"."width=20 height=20"."/>";
            echo    "</button>"."</br>";

            echo  "<span id="."qntCurtidas".">"."Curtiram isso "; include('../back/contalikes.php');
